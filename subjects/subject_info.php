                                    ...
                                    <div class="col s3 md3">
                                        <div class="card z-depth-0" id="card">
                                            ...
                                            <div class="card-action right-align">
                                                ...
                                                <a class="brand-text" href="subjects/subject_edit_form.php?id=<?php echo $s['subject_id'];?>&title=<?php echo $s['subject_title'];?>&credits=<?php echo $s['subject_credits'];?>&type=<?php echo $s['subject_type'];?>&lectured_by=<?php echo $s['subject_lectured_by'];?>">Edit subject</a>
